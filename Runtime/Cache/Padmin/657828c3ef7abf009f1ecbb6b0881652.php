                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-xs"><i class="fa fa-user"></i> 作者</th>
                                <th class="hidden-xs"><i class="fa fa-tags"></i> 分类</th>
                                <th><i class="fa fa-thumbs-o-up"></i> 阅读数</th>
                                <th><i class="fa fa-check-square-o"></i> 发布时间</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody class="article-list">
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="highlight">
                                        <div class="<?php echo fny_array_rand(array('success','info','warning'));?>">
                                        </div>
                                        <a href="javascript:;">
                                        <?php echo ($vo['title']); ?> </a>
                                    </td>
                                    ...
                                    <td class="hidden-xs">
                                        <?php if(is_array($vo['cates'])): $i = 0; $__LIST__ = $vo['cates'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i; echo ((isset($cate['name']) && ($cate['name'] !== ""))?($cate['name']):"-"); endforeach; endif; else: echo "" ;endif; ?>
                                    </td>
                                    <td>
                                        <?php echo ($vo['click_num']); ?>
                                    </td>
                                    <td>
                                        <?php echo (date("Y-m-d",$vo['addtime'])); ?>
                                    </td>
                                    <td class="col-md-3">
                                        <a href="<?php echo U('/Padmin/Article/edit',array('aid'=>$vo['id']));?>" class="btn default btn-xs purple">
                                        <i class="fa fa-edit"></i> 编辑 </a>
                                        <a href="javascript:;" data-aid = "<?php echo ($vo['id']); ?>"  class="btn default btn-xs red article-delete">
...
<!-- 确认弹出层 -->
<div aria-hidden="true" role="dialog" tabindex="-1" id="msg-confirm" class="modal fade modal-scroll">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn default" id="confirm-del" type="button">确定</button>
